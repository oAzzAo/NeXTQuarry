...
public class Updater {
	...
	public static void updateResultCustom(Updater updater) {
		...
		case SUCCESS:
			Bukkit.getServer().broadcastMessage(
					ChatColor.BOLD + "" + ChatColor.AQUA
							+ "NeXTQuarry has updated to the new version: "
			...
			Bukkit.getServer()
					.broadcastMessage(
							ChatColor.BOLD
									+ ""
									+ ChatColor.AQUA
									+ "Please restart the server, or use the /reload command, to apply the changes.");
			break;
		case FAIL_DOWNLOAD:
			Bukkit.getServer()
					.broadcastMessage(
							ChatColor.BOLD
									+ ""
									+ ChatColor.RED
									+ "There was an update available for NeXTQuarry, but the download failed. Error Code: 001");
			Bukkit.getServer()
					.broadcastMessage(
							ChatColor.BOLD
									+ ""
									+ ChatColor.RED
									+ "Please download and install the new version of NeXTQuarry manually.");
			break;
		case FAIL_DBO:
			Bukkit.getServer()
					.broadcastMessage(
							ChatColor.BOLD
									+ ""
									+ ChatColor.RED
									+ "There was an update available for NeXTQuarry, but the download failed. Error Code: 002");
			Bukkit.getServer()
					.broadcastMessage(
							ChatColor.BOLD
									+ ""
			...
			Bukkit.getServer()
					.broadcastMessage(
							ChatColor.BOLD
									+ ""
									+ ChatColor.RED
									+ "There was an update available for NeXTQuarry, but the download failed. Error Code: 003");
			Bukkit.getServer()
					.broadcastMessage(
							ChatColor.BOLD
									+ ""
			...
			Bukkit.getServer()
					.broadcastMessage(
							ChatColor.BOLD
									+ ""
									+ ChatColor.RED
									+ "There was an update available for NeXTQuarry, but the download failed. Error Code: 004");
			Bukkit.getServer()
					.broadcastMessage(
							ChatColor.BOLD
									+ ""
		...
		case UPDATE_AVAILABLE:
			Bukkit.getServer().broadcastMessage(
					ChatColor.BOLD + "" + ChatColor.AQUA
							+ "A new update for NeXTQuarry is available!");
			Bukkit.getServer()
					.broadcastMessage(
							ChatColor.BOLD
									+ ""
									+ ChatColor.AQUA
									+ "Please download and install the new version of NeXTQuarry to update.");
		default:
			break;
		}
	}
